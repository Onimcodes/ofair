...
Future<void> setup() async {
  ...
  getit.registerLazySingleton<SignalRService>( () => SignalRService(baseUrl: 'https://cafecardapi.onrender.com'), );
  ...
  getit.registerFactory(() => ChatBloc(usersRepository: getit(),
                                        signalService: getit()));
  getit.registerFactory(() => ChatHistoryBloc(usersRepository: getit(), signalService: getit()));
